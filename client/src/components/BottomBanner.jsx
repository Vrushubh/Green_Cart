...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
        <img src={assets.bottom_banner_image} className='w-full hidden md:block' alt="Bottom_Banner" />
        <img src={assets.bottom_banner_image_sm} className='w-full md:hidden' alt="Bottom_Banner" />
